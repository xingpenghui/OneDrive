package com.feri.onedrive.admin.core.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo createAI(){
        return new ApiInfoBuilder().title("壹座驾平台后台管理系统数据接口").
    ...
    public Docket createD(){
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(createAI()).select().apis
                (RequestHandlerSelectors.basePackage("com.feri.onedrive.admin.web")).build();
    }
}
